...
\begin{document}
	...
	\section{Vulnerabilități} % (fold)
	\label{sec:Vulnerabilități}
		\subsection{OWASP (Open Web Application Security Project)} % (fold)
		\label{sub:OWASP}
		OWASP este o organizație mondială caritabilă non-profit care are ca scop îmbunătățirea securității software.
		% subsection OWASP (end) 
	% section Vulnerabilități (end)
